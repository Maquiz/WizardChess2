...
/// <summary>
/// Continental Divide: Create a line of Stone Walls in any direction from the Queen.
/// </summary>
public class EarthQueenActive : IActiveAbility
{
    private readonly EarthQueenActiveParams _params;

    public EarthQueenActive() { _params = new EarthQueenActiveParams(); }
    public EarthQueenActive(EarthQueenActiveParams p) { _params = p; }
    ...
    public List<Square> GetTargetSquares(PieceMove piece, BoardState bs)
    {
        ...
        foreach (var dir in allDirs)
        {
            ...
            if (lastEmpty != null) targets.Add(lastEmpty);
        }
        return targets;
    }
